...
## Recent Changes
- July 31, 2025: Fixed Dashboard spacing and filtering: converted Day/Week/Month/Lifetime buttons to dropdown menus in Earnings and Investment Breakdown containers, implemented My Listed Properties filtering by Favorites/Saved selections, added "View All Properties" navigation to Invest page, removed duplicate close buttons from all popup windows, and enhanced Learn page hover effects with wider button backgrounds and consistent brick red color for "Start Guide" buttons
