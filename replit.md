...
## Recent Changes
- July 31, 2025: Added Contact page and enhanced security features: created comprehensive Contact page with FAQs section covering real estate investing questions, support contact information, and contact form with categorized inquiries, added Contact link to footer Company section, removed duplicate close buttons from PayPal popup, and implemented KYC/AML identity verification using Veriff.com in Security tab with regulatory compliance messaging
